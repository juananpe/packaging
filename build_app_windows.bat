...
set JAVA_VERSION=17
set MAIN_JAR=packaging-%PROJECT_VERSION%.jar
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\com\example\packaging\Main.class > temp.txt
...
call "%JAVA_HOME%\bin\jpackage" ^
  ...
  --name Packaging ^
  --main-class com.example.packaging.Main ^
  --main-jar %MAIN_JAR% ^
